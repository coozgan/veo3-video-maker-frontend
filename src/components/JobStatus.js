...
export function JobStatus({ operationName, result, error }) {
    ...
    return (_jsxs(Card, { className: "overflow-hidden rounded-xl p-0", children: [_jsx("video", { src: result.videoUrl, controls: true, autoPlay: true, loop: true, className: "block w-full bg-black" }), _jsxs("div", { className: "flex items-center justify-between gap-3 border-t border-border px-4 py-4", children: [_jsx("span", { className: "text-sm text-fg-muted", children: "Your video is ready." }), _jsx("a", { href: result.videoUrl, download: true, children: _jsxs(Button, { variant: "outline", size: "sm", type: "button", children: [_jsx(Download, { size: 14 }), "Download"] }) })] })] }));
}
